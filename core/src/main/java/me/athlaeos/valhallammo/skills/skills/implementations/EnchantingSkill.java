...
public class EnchantingSkill extends Skill implements Listener {
    ...
    public void addEXP(Player p, double amount, boolean silent, PlayerSkillExperienceGainEvent.ExperienceGainReason reason) {
        ...
        if (reason == PlayerSkillExperienceGainEvent.ExperienceGainReason.SKILL_ACTION) {
            amount *= (1 + AccumulativeStatManager.getCachedStats("ENCHANTING_EXP_GAIN", p, 1000, true));
        }
    ...
    public void onPrepareEnchant(PrepareItemEnchantEvent e) {
        ...
        if (!existingLevelOffers.containsKey(e.getEnchantmentBonus())){
            ...
            double chance = AccumulativeStatManager.getCachedStats("ENCHANTING_AMPLIFY_CHANCE", e.getEnchanter(), 1000, true);
